 ...
 */
export type SupportedInputMimeType = 'application/pdf' | 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' | 'application/vnd.openxmlformats-officedocument.presentationml.presentation' | 'text/html' | 'text/markdown';
/**
 ...
 */
export type ImageDescriber = (image: EmbeddedImage) => Promise<string | null | undefined>;
/**
